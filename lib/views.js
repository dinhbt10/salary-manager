...
export const NV_VIEW = `
  SELECT nv.manv, nv.hoten, nv.gioitinh, nv.ngaysinh, nv.cmnd, nv.email, nv.dienthoai, nv.diachi,
         nv.sotaikhoan, nv.ngayvaolam, nv.trangthai, nv.mapb, pb.tenpb, nv.macv, cv.tencv,
